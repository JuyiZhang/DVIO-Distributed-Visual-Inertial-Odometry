...
class Device:
    ...
    def get_device_transform_at_timestamp(self, timestamp: int) -> np.ndarray:
        ...
        return Utility.get_inv_transformation_of_point(transform_device_coordinate[0], transform_device_coordinate[2], transform_device_coordinate[3])
    ...
    def get_transformation_matrix_from(self, rotation: np.ndarray, displacement: np.ndarray):
        ...
        disp_matrix_a = np.matrix([[1,0,0,displacement[0] - 0.25],[0,1,0, displacement[1]],[0,0,1, displacement[2] + 0.75],[0,0,0,1]])
